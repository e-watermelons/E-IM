...
public enum ImUrlRouteWayEnum {
     ...
     * 随机
     */
    RAMDOM(1, "top.emanjusaka.eim.common.route.algorithm.random.RandomHandle"),


    /**
     * 1.轮训
     */
    LOOP(2, "top.emanjusaka.eim.common.route.algorithm.loop.LoopHandle"),

    /**
     * HASH
     */
    HASH(3, "top.emanjusaka.eim.common.route.algorithm.consistenthash.ConsistentHashHandle"),
    ;
