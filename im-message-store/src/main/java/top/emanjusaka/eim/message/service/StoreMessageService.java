package top.emanjusaka.eim.message.service;
...
import top.emanjusaka.eim.message.dao.ImGroupMessageHistoryEntity;
import top.emanjusaka.eim.message.dao.ImMessageBodyEntity;
import top.emanjusaka.eim.message.dao.ImMessageHistoryEntity;
import top.emanjusaka.eim.message.dao.mapper.ImGroupMessageHistoryMapper;
import top.emanjusaka.eim.message.dao.mapper.ImMessageBodyMapper;
import top.emanjusaka.eim.message.dao.mapper.ImMessageHistoryMapper;
import top.emanjusaka.eim.message.model.DoStoreGroupMessageDto;
import top.emanjusaka.eim.message.model.DoStoreP2PMessageDto;
